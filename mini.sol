...
contract Record {
    ...
    function setDoctor(string _ic, string _name, string _phone, string _gender, string _dob, string _qualification, string _specialization) public {
    ...
    function editDoctor(string _ic, string _name, string _phone, string _gender, string _dob, string _qualification, string _specialization) public {
        require(isDoctor[msg.sender]);
        var d = doctors[msg.sender];
    ...
    function searchDoctor(address _address) public view returns(string, string, string, string, string, string, string) {
        ...
        return (d.ic, d.name, d.phone, d.gender, d.dob, d.qualification, d.specialization);
    }
